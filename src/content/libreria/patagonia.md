...
excerpt: Il vento in Patagonia non è un elemento climatico — è un personaggio. Tira da ovest con una costanza fisica che modella il paesaggio, piega gli alberi, cambia i piani. Torres del Paine, il Perito Moreno, la Ruta 40. Posti che esistono a una scala che il corpo non è abituato a processare.
publishDate: 2026-07-15
featured: true
pullQuote: In Patagonia il vento decide. Non il tuo itinerario, non la tua agenda — il vento.
essentialToKnow:
  - title: Quando andare
    description: Novembre–marzo è l'estate australe — l'unica stagione praticabile per trekking seri. Dicembre e gennaio sono il picco (più caldo, più gente). Novembre e marzo sono i mesi giusti per chi vuole meno folla e accetta qualche giorno di meteo incerto. L'inverno (giugno–agosto) è per chi cerca il silenzio assoluto e non ha fretta di camminare.
  - title: Argentina vs Cile
    description: Sono due parchi diversi con logiche diverse. El Chaltén (Argentina) è più libera e selvaggia — nessun permesso, sentieri aperti, camping libero. Torres del Paine (Cile) è gestita con permessi obbligatori, rifugi prenotabili un anno prima, circuiti marcati. Entrambe valgono. Dipende da che tipo di viaggiatore sei.
  - title: Logistica
    description: La porta d'ingresso principale è El Calafate (Argentina) per Perito Moreno e El Chaltén. Puerto Natales (Cile) per Torres del Paine. Tra le due ci sono 5 ore di bus. Il confine si attraversa facilmente. Noli auto costosi — prenotare mesi prima nella stagione alta.
  - title: Fotografia
    description: Il vento è il nemico principale dell'attrezzatura — filtri che volano, polvere ovunque, treppiede che oscilla. Novembre e marzo hanno le ore d'oro più lunghe. A El Chaltén, il Fitz Roy cattura le prime luci dell'alba solo quando il cielo è parzialmente nuvoloso — con cielo sereno rimane in ombra fino a tardi.
mapCenter:
  lat: -49.5
  lng: -72.5
  zoom: 6
