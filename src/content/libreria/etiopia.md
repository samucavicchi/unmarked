...
title: Etiopia
subtitle: Il continente dentro il continente
country: Etiopia
continent: Africa
coverImage: ../../assets/articoli/the-eyes-of-africa.jpeg
coverImageAlt: Sguardo diretto di un abitante dell'Etiopia rurale
excerpt: La Depressione di Danakil è uno dei posti più ostili della Terra — 125 metri sotto il livello del mare, 50 gradi di giorno, vulcani attivi e laghi di acido. Qualcuno ci vive. Questo racconta molto dell'Etiopia.
publishDate: 2026-06-27
featured: true
pullQuote: L'Etiopia non è Africa per come l'Africa viene raccontata. Ha la sua scrittura, la sua religione, la sua cucina. Non è mai stata colonizzata. Si vede.
essentialToKnow:
  - title: Quando andare
    description: Ottobre–febbraio per la stagione secca. La Danakil è praticabile tutto l'anno ma in estate supera i 55°C — è tecnicamente possibile, è praticamente sconsigliato. Le highland del nord sono più fresche e godibili in qualsiasi stagione.
  - title: Sicurezza
    description: Il paese è grande e la situazione varia enormemente per regione. Le aree turistiche classiche (nord storico, Omo valley, Lalibela) sono frequentate senza problemi. Il Tigray e alcune zone est richiedono aggiornamenti recenti prima di partire.
  - title: Altitudine
...
mapMarkers:
  ...
  - lat: 14.2333
    lng: 40.2833
    label: Depressione di Danakil
  - lat: 5.9000
    lng: 36.5500
    label: Valle dell'Omo
---
