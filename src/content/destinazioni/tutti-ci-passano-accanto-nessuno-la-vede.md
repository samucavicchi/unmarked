...
featured: false
interludeImage: ../../assets/articoli/aldeyarfoss-6.jpg
pullQuote: un luogo che racconta l'essenza dell'Islanda
bodyText2: >-
  Fotograficamente è un luogo straordinario proprio per questo contrasto: il
  bianco dell’acqua contro il nero della lava, la curva morbida del fiume contro
  la verticalità delle colonne basaltiche, il movimento continuo dentro una
  scena apparentemente immobile. È una cascata che funziona bene in inverno,
  quando la neve alleggerisce i contrasti, ma anche in estate, quando il
  paesaggio rivela tutta la sua materia vulcanica.
...
gallery2:
  - image: ../../assets/articoli/aldeyarfoss-6.jpg
    caption: Dall'alto è bella, ma per chi trova il coraggio di scendere, è tutta un
      altra musica
  - image: ../../assets/articoli/aldeyarfoss-3.jpg
    caption: Nonè bella solo la cascata, il contensto basaltico la rende unica
  - image: ../../assets/articoli/aldeyarfoss-1.jpg
    caption: I colori all'alba
essentialToKnow:
  - title: In inverno
    description: In inverno questa cascata da il meglio di se ma, non si puo
      raggiungere in auto, la strada è chiusa, dopo 40 km di guida su strada
      sterrata, probabilmente ghiacciata, gli ultimi 8km vanno percorsi a piedi
